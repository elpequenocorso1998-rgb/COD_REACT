...
import { WEAPONS, PERKS, ATTACHMENTS, ATTACHMENT_SLOTS } from '@/game/core/config'
import { getLoadout, saveLoadout, getCustomClasses, setActiveClassIndex, getActiveClassIndex, duplicateClass, resetClass, getMaxClasses } from '@/game/player/loadout'
import { getSettings, saveSettings } from '@/game/meta/settings'
import { t, setLang, getLang } from '@/i18n'
import { createNetClient } from '@/net/client'
import { getMetaSummary, getWeaponStats, CAMO_CATALOG } from '@/game/meta/meta'
import { DEFAULT_KEYBINDINGS } from '@/game/accessibility/index'
import { MAPS, MAP_IDS } from '@/game/maps/index'
import { GAME_MODES } from '@/game/modes/index'
import { getPrestige, canPrestige, prestige as doPrestige } from '@/game/backend/live-service'
