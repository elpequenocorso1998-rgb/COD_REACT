...
import { createEnemyManager, ENEMY_TYPES, WAVE_SCALING } from '@/game/enemies/enemies'
import { createParticleSystem } from '@/game/effects/particles'
import { createEnvironment } from '@/game/effects/environment'
import { createAudioSystem } from '@/game/effects/audio'
import { createMinimap } from '@/game/effects/minimap'
import { createStreakManager } from '@/game/items/streaks'
import { createGrenadeSystem } from '@/game/items/grenades'
import { createDecalSystem } from '@/game/effects/decals'
...
import { createRemotePlayerManager } from '@/game/competitive/remote-players'
import { createSpectator } from '@/game/competitive/spectator'
import { useGameStore, GAME_STATES } from '@/game/core/store'
import {
  FOV, CAMERA_NEAR, CAMERA_FAR, MAX_PARTICLES, WAVE_BASE, WAVE_PER_WAVE,
  FLOOR_SIZE
} from '@/game/core/constants'
import { GRENADES, PLAYER, FIELD_UPGRADES } from '@/game/core/config'
import { getLoadout, hasPerk } from '@/game/player/loadout'
import { getSettings } from '@/game/meta/settings'
import { FpsSampler, applyQuality } from '@/game/effects/quality'
import { createAccessibilityManager } from '@/game/accessibility/index'
import { createFrameProfiler } from '@/game/performance/profiler'
import { getGameMode } from '@/game/modes/index'
